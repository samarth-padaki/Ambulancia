...
The following example clones the "[DEEPCRAFT&trade; Studio Deploy Audio](https://github.com/Infineon/mtb-example-psoc-edge-ml-deepcraft-delpoy-audio)" application with the desired name "DeployAudio" configured for the *KIT_PSE84_EVAL_EPC2* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSE84_EVAL_EPC2 --app-id mtb-example-psoc-edge-ml-deepcraft-deploy-audio --user-app-name DeployAudio --target-dir "C:/mtb_projects"
   ```
